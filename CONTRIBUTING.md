...
2. In your clone of github.com/BSP-Mosaic/revel, add your fork as a remote.
3. Push to your fork to prepare a pull request.

Here is the command line: 
```
$ cd $GOPATH/src/github.com/BSP-Mosaic/revel              # Change directory to revel repo
...
Typically running the main set of unit tests will be sufficient:
	...
	$ go test github.com/BSP-Mosaic/revel

Refer to the
[Travis configuration](https://github.com/BSP-Mosaic/revel/blob/master/.travis.yml)
...
[issues](https://github.com/BSP-Mosaic/revel/issues?labels=contributor+ready&page=1&state=open).
